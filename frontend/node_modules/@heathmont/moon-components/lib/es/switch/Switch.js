...
var Slider = styled.span.withConfig({
  ...
  return {
    ...
    backgroundImage: colorScheme ? "".concat(inlineSvg( /*#__PURE__*/React.createElement(IconMoon, null)), ", ").concat(inlineSvg( /*#__PURE__*/React.createElement(IconSun, null))) : undefined,
    backgroundPosition: "left ".concat(rem(space.small), " center, right ").concat(rem(space.small), " center"),
    backgroundRepeat: 'no-repeat',
    borderRadius: "calc(".concat(switchWidth, " + ").concat(rem(2), ")"),
    transitionProperty: 'background-color',
    transitionDuration: "".concat(transitionDuration.slow, "s"),
    transitionTimingFunction: 'ease',
    '&::before': {
      '--switch-indicator-size': "calc(".concat(switchHeight, " - ").concat(rem(space.small), ")"),
      content: '""',
      position: 'absolute',
...
var Label = styled.label.withConfig({
  ...
  return _ref3 = {}, _defineProperty(_ref3, switchWidthProperty, rem(space.large * 2)), _defineProperty(_ref3, switchHeightProperty, rem(space.large)), _defineProperty(_ref3, "position", 'relative'), _defineProperty(_ref3, "display", 'inline-block'), _defineProperty(_ref3, "width", switchWidth), _defineProperty(_ref3, "height", switchHeight), _defineProperty(_ref3, "flexShrink", 0), _ref3;
});
var Input = styled.input.withConfig({
  ...
  return _objectSpread(_objectSpread({}, hideVisually()), {}, _defineProperty({}, "&:checked + ".concat(Slider), {
...
var SwitchCaption = styled(Caption).withConfig({
...
var Switch = function Switch(_ref6) {
  ...
  var autoId = id || "Switch-".concat(uniqueId());
  var labelProps = {
    className: className
  };
  ...
  }, captionUnchecked && /*#__PURE__*/React.createElement(SwitchCaption, {
    checked: checked
  }, captionUnchecked), /*#__PURE__*/React.createElement(Label, labelProps, /*#__PURE__*/React.createElement(Input, inputProps), /*#__PURE__*/React.createElement(Slider, sliderProps)), captionChecked && /*#__PURE__*/React.createElement(SwitchCaption, {
    checked: !checked
  }, captionChecked));
};
