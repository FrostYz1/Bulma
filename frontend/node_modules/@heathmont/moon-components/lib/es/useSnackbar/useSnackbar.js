...
var useSnackbar = function useSnackbar(_ref) {
  ...
  var displaySnackbar = function displaySnackbar() {
    setVisibility(true);
    setTimeout(hideSnackbar, timeout);
  };

  var SnackbarWithTimeout = visible && /*#__PURE__*/React.createElement(Snackbar, rest);
