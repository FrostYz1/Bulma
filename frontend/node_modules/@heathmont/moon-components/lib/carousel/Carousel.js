...
var _withHorizontalScroll2 = require("../withHorizontalScroll/withHorizontalScroll");
...
var CarouselWrapper = _styledComponents["default"].div.withConfig({
...
var ItemsScrollWrapper = (0, _styledComponents["default"])(_Reel["default"].withComponent('ul')).withConfig({
  ...
  return horizontalEdgeGap && {
    padding: "0 ".concat((0, _moonUtils.rem)(horizontalEdgeGap)),
    margin: "0 ".concat((0, _moonUtils.rem)(-horizontalEdgeGap))
  };
}, function (_ref2) {
...
var CarouselScrollItem = _styledComponents["default"].li.withConfig({
...
var Carousel = function Carousel(_ref5) {
  ...
  var _withHorizontalScroll = (0, _withHorizontalScroll2.withHorizontalScroll)({
    scrollStep: step || 5
  }),
