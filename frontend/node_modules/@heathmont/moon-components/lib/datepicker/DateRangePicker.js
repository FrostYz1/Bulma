...
var DateRangePicker = function DateRangePicker(_ref) {
  ...
  var _React$useState = _react["default"].useState(isOpenByDefault),
      _React$useState2 = _slicedToArray(_React$useState, 2),
      isOpen = _React$useState2[0],
      setIsOpen = _React$useState2[1];

  var _React$useState3 = _react["default"].useState((0, _getPlaceholder.getPlaceholder)({
    startDate: startDate,
    endDate: endDate,
    range: range,
    config: config,
  ...
  return /*#__PURE__*/_react["default"].createElement(Wrapper, null, /*#__PURE__*/_react["default"].createElement(_.Button, {
    variant: "tertiary",
    onClick: function onClick() {
      return setIsOpen(true);
    }
  }, placeholder), isOpen && /*#__PURE__*/_react["default"].createElement(_RangeCalendar["default"], {
    startDate: startDate,
    endDate: endDate,
    range: range,
    config: config,
